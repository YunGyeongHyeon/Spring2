...
<html>
	...
	<body>
		...
		<div style="float:right;">
			...
			<c:if test="${mid==null }">
				<a href="loginForm" class="btn btn-info" style="font-size:0.6em">로그인</a>
				<a href="join" class="btn btn-info" style="font-size:0.6em">회원가입</a>
			</c:if>
			<c:if test="${mid!=null}">
				<span>${mid}님</span>
				<a href="logout" class="btn btn-danger" style="font-size:0.6em">로그아웃</a>
			</c:if>
		</div>
		...
		<div style="display:flex;">
			<div style="flex-grow:1;">
				...
				<c:if test="${groupNo!=endPageNo}">
					<a href="boardList?pageNo=${totalPageNum}" class="btn btn-primary">맨끝</a>				
				</c:if>
			</div>
			<div><a class="btn btn-primary" href="writeBoardForm">글쓰기</a></div>
		</div>
	</body>
</html>