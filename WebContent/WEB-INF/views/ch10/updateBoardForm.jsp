	...
	<body>
		...
		<form method="post" action="updateBoard" onsubmit="return checkForm()">
		  ...
		  <div class="form-group">
		    ...
		    <input id="btitle" name="btitle" type="text" class="form-control" value="${board.btitle}"placeholder="제목을 입력하세요.">
		    <span class="error" id="btitleError" style="color:red;font-size:0.7em "></span>
		  </div>
		  <div class="form-group">
		    <label for="bcontent">Content</label>
		    <textarea class="form-control" id="bcontent" name="bcontent" rows="3" placeholder="내용을 입력하세요.">${board.bcontent}</textarea>
